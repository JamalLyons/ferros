...
compile_error!("This example is macOS-only. It uses ferros-core's macOS implementation which requires Mach APIs.");
    ...
    match attach_and_read_registers(pid) {
        ...
        Err(e) => {
            ...
            match e {
                ...
                // Unknown Mach error
                ferros_core::error::DebuggerError::MachError(ferros_core::platform::macos::error::MachError::Unknown(
                    code,
                )) => {
